...
const AdvancedMap = dynamic(() => import("@/components/ui/interactive-map").then((mod) => mod.AdvancedMap), { 
  ssr: false,
  loading: () => <div className="h-full w-full bg-slate-100 animate-pulse flex items-center justify-center text-slate-400 font-bold">Loading Interactive Map...</div>
})
...
const pharmacies = [
  ...
  },
  {
    ...
    isOpen: true,
    position: [6.9147, 79.8974] as [number, number],
  },
  {
    name: 'CureAll Drugs',
    ...
    isOpen: false,
    position: [6.8649, 79.8997] as [number, number],
  },
]
...
export default function PharmacyPage() {
  ...
  const mapMarkers = pharmacies.map((p, i) => ({
    id: i,
    position: p.position,
    color: p.isOpen ? 'blue' : 'red',
    popup: {
      title: p.name,
      content: p.address,
      image: `https://images.unsplash.com/photo-1586024491624-d67a5dfec3b4?auto=format&fit=crop&q=80&w=400&h=250`
    }
  }))
    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 lg:ml-[80px] xl:ml-[280px] p-0 md:p-0 pt-20 lg:pt-0">
        <div className="flex h-full flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[450px] bg-white border-r border-slate-100 flex flex-col h-screen overflow-hidden shrink-0">
            <div className="p-6 border-b border-slate-50">
              ...
              <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 mb-6 font-primary">Pharmacies Near You</h1>
              ...
              <div className="space-y-3">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="h-14 w-full rounded-2xl border border-slate-100 bg-slate-50 pl-12 pr-4 focus:bg-white focus:border-primary-500 transition-all outline-none font-bold"
                  />
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {pharmacies.map((pharmacy, i) => (
                <motion.div
                  ...
                  className="rounded-3xl border border-slate-100 bg-white p-5 shadow-xs hover:shadow-xl hover:border-primary-100 transition-all cursor-pointer group"
                >
          ...
          {/* Right Section: Map */}
          <div className="flex-1 relative hidden lg:block overflow-hidden bg-slate-100 min-h-0 h-screen">
            <AdvancedMap 
